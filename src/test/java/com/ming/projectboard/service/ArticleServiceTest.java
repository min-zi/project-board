...
class ArticleServiceTest {
    ...
    void givenSearchParameters_whenSearchingArticle_thenReturnsArticleList() {
        ...
        // When
        Page<ArticleDto> articles = sut.searchArticles(SearchType.TITLE, "search keyword"); // 검색, 본문, ID, 닉네임, 해시태그
    ...
    void givenId_whenSearchingArticle_thenReturnsArticle() {
        ...
        // When
        ArticleDto articles = sut.searchArticle(1L); // 검색, 본문, ID, 닉네임, 해시태그
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        ...
        // When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "Minzi", "title", "content", "#java"));
